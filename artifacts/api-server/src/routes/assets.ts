...
router.post("/assets", async (req, res) => {
  ...
  await db.insert(auditLogsTable).values({
    ...
    entityId: asset.id,
    actor: "system",
    details: `Content generated for campaign "${campaign.name}"`,
  });
...
router.get("/assets/:id/variants", async (req, res) => {
